...
<a href="/actions/trainer/">trainer</a> | Convert the Xcode plist log to a JUnit report | ios, mac
...
Action | Description | Supported Platforms
---|---|---
<a href="/actions/gym/">gym</a> | Alias for the `build_app` action | ios, mac
...
<a href="/actions/match/">match</a> | Alias for the `sync_code_signing` action | ios, mac
...
<a href="/actions/sourcedocs/">sourcedocs</a> | Generate docs using SourceDocs | ios, mac
...
Action | Description | Supported Platforms
---|---|---
<a href="/actions/pilot/">pilot</a> | Alias for the `upload_to_testflight` action | ios, mac
<a href="/actions/testflight/">testflight</a> | Alias for the `upload_to_testflight` action | ios, mac
...
<a href="/actions/latest_testflight_build_number/">latest_testflight_build_number</a> | Fetches most recent build number from TestFlight | ios, mac
...
<a href="/actions/jira/">jira</a> | Leave a comment on a Jira ticket | ios, android, mac
